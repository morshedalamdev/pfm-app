...
import { emptyToNull, profileInitials } from "@/lib/settings/utils";
...
function ProfileForm({ profile }: { profile: Profile }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const saved = await save.mutateAsync({ about: emptyToNull(about), email: email.trim(), full_name: emptyToNull(fullName), occupation: emptyToNull(occupation), phone_number: emptyToNull(phone) });
      setUser(saved);
