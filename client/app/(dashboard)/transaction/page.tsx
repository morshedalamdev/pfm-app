...
export default function Transaction() {
  return (
    <main className="flex flex-col h-dvh">
      ...
      <section className="space-y-4 px-3 h-[calc(100%-106px)] pb-[70px] overflow-y-auto">
        <div className="space-y-2">
          <div className="flex items-center justify-between border-b border-input pb-1 mt-2">
