...
export default function Analytics() {
  ...
  return (
    <main className="flex flex-col h-dvh">
      ...
      <div className="h-[calc(100%-48px)] pb-[68px] overflow-y-auto">
            ...
            <li className="border border-input rounded-md p-2">
              <div className="flex flex-wrap gap-1.5">
                ...
                <div className="flex-1 flex flex-col gap-0.5">
                  ...
                  <div className="flex flex-wrap justify-between text-input">
                    <p>40% of budget</p>
        ...
        <section className="p-2">
          ...
          <ul className="space-y-2">
            ...
            <li className="border border-input rounded-md p-2">
              <div className="flex flex-wrap gap-2">
                <div className="flex-1">
                  <h3 className="text-input mb-2">Budget Adherence</h3>
                  <Progress value={40} />
                </div>
